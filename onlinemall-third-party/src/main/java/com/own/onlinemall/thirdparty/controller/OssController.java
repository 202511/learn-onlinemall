...
public class OssController {
    ...
    public Map<String, String> get(HttpServletRequest request, HttpServletResponse response)
    {
        ...
        String accessId = "LTAI5tApdnt5yyF4FE5Yruqb";
        String accessKey = "mD17yDCAjnxioUCuIxH3AE9axsxbfD";
        // Endpoint以华东1（杭州）为例，其它Region请按实际情况填写。
        String endpoint = "oss-cn-guangzhou.aliyuncs.com";
        // 填写Bucket名称，例如examplebucket。
        String bucket = "com-own-onlinemall";
        // 填写Host地址，格式为https://bucketname.endpoint。
        String host = "https://com-own-onlinemall.oss-cn-guangzhou.aliyuncs.com";
        // 设置上传回调URL，即回调服务器地址，用于处理应用服务器与OSS之间的通信。OSS会在文件上传完成后，把文件上传信息通过此回调URL发送给应用服务器。
        String callbackUrl = "https://192.168.206.1:30000";
